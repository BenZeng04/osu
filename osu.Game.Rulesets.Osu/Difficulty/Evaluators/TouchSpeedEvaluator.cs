    ...
    public static class TouchSpeedEvaluator
    {
        ...
        public static double EvaluateDifficultyOf(DifficultyHitObject current)
        {
            ...
            bool isSingletapped = touchData.Action is not OsuTouchAction.OsuDragAction
                ...
                && touchData.ActingHand == touchData.PrevActingHand;
            ...
            double strainTimeMultiplier = 0.5;
            double speedValue = SpeedEvaluator.EvaluateDifficultyOf(evaluationObject, strainTimeMultiplier);
